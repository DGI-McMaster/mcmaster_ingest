...
if __name__ == '__main__':
    ...
    logFile = os.path.join(log_directory,'/big2/dc/ingest/Epistemology' + time.strftime('%y_%m_%d') + '.log')
    ...
    for mods_file in mods_files:
        if mods_file.endswith('_MODS.xml'):
            ...
            #add cover/tn ds
            tn_cover_file = book_name + '-0001.jpg'
            ...
            for tif_page_file in book_page_tif_page_files:
                ...
                #add tn ds
                jpg_page_file = book_name + '-' + page_name + '.jpg'
                jpg_page_file_path = os.path.join(source_directory, 'jpg', jpg_page_file)
                jpg_page_file_handle = open(jpg_page_file_path, 'rb')
                try:
                    page_object.addDataStream(u'JPEG', u'aTmpStr', label = u'JPEG',
                    mimeType = u'image/jpg', controlGroup = u'M',
                    logMessage = u'Added JPEG datastream.')
                ...
                #add page-tn ds
                tn_page_file = book_name + '-' + page_name + '.jpg'
                ...
                #add jp2 ds
                jp2_page_file = book_name + '-' + page_name + '.jp2'
                ...
                #add tif ds
                tif_page_file = book_name + '-' + page_name + '.tif'
