...
if __name__ == '__main__':
    ...
    setup
    '''
    hamilton_rdf_name_space = fedora_relationships.rels_namespace('macrepo', 'http://repository.mcmaster.ca/ontology#')
    ...
    report_directory = os.path.join(source_directory)
    if not os.path.isdir(report_directory):
        logging.error('REOPORT directory invalid \n')
        sys.exit()
    ...
    images_directory = os.path.join(source_directory, 'IMAGES', 'tif', 'jpg_medium', 'jp2_lossy','jp2_lossless')
    ...
    metadata_files = os.listdir(mods_directory)
    images_files = os.listdir(tei_directory)
    pdf_page_files = os.listdir(tei_page_directory)
