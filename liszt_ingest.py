...
if __name__ == '__main__':
    ...
    logFile = os.path.join(log_directory,'/big2/dc/Digital-Collections/archival-objects/liszt' + time.strftime('%y_%m_%d') + '.log')
    ...
    mods_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/mods')
    if not os.path.isdir(mods_directory):
        logging.error('MODS directory invalid \n')
        sys.exit()
 
    macrepo_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/macrepo')
    if not os.path.isdir(macrepo_directory):
        logging.error('MODS directory invalid \n')
        sys.exit()
   
    tif_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/tif')
    if not os.path.isdir(tif_directory):
        logging.error('TIF directory invalid \n')
        sys.exit()

    jpg_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/jpg')
    if not os.path.isdir(jpg_directory):
        logging.error('JPG directory invalid \n')
        sys.exit()

    fits_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/fits')
    if not os.path.isdir(fits_directory):
        logging.error('FITS pages directory invalid \n')
        sys.exit()
    
    jp2_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/jp2')
    if not os.path.isdir(jp2_directory):
        logging.error('JP2 directory invalid \n')
        sys.exit()
    
    tn_directory = os.path.join(source_directory, '/big2/dc/Digital-Collections/archival-objects/liszt/tn')
    ...
    do ingest
    '''
    #put in the liszt collection object
    try:
        collection_label = u'132'
        ...
        if object_fetch_exception.httpcode in [404]:
            logging.info(name_space + ':liszt missing, creating object.\n')
